...
<?php endif; ?>
	...
	<td colspan="3">
	<?php __('Physical Memory'); ?> <span id="meminfo_Tostal" class="text-info">336.167 G </span>
	...
	, 
	<div class="progress">
	<div id="meminfo_UsedBar" class="progress-bar progress-bar-warning" role="progressbar" style="width:28%" ></div>
	<div id="meminfo_BuffersBar" class="progress-bar progress-bar-info" role="progressbar" style="width:15%" ></div>
	<div id="meminfo_CachedBar" class="progress-bar progress-bar-success" role="progressbar" style="width:20%" ></div>
	</div>
...
<?php endif; ?>
	...
	<td colspan="3">
	<?php __('Total Space'); ?> 69968.54 &nbsp;G，
	<?php __('Used'); ?> <span id="diskinfo_Used"><?php echo $diskinfo['diskUsed'];?></span>&nbsp;G
	<div class="progress"><div id="diskinfo_UsedBar" class="progress-bar progress-bar-black" role="progressbar" style="width:3%" ></div> </div>
	</td>
	</tr>
	<tr>
