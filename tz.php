...
/* ---------------------------------------------------- */
/* 雅黑探针修改版
/* 使其对腾讯云Cloud Studio PHP运行环境完美支持
/* https://github.com/insoxin/tz
/* ---------------------------------------------------- */
/* ---------------------------------------------------- */
/* 程序名称: PHP探针-Yahei
...
<div id="page">
    <div id="header">
        ...
        <div id="download"><img src="https://api.isoyu.com/ARU_GIF_S.php"  alt="姬长信api" /></div>
    </div>
...
<div id="footer"><iframe src="https://api.isoyu.com/gy/" frameborder="0" scrolling="no" width="300" height="300"></iframe><br>
&copy; <?php echo date("Y",time());?> <A HREF="https://github.com/insoxin/tz" target="_blank"><?php echo $title.$version;?></A> 修改版，使其对腾讯云Cloud Studio PHP运行环境完美支持<br />
<?php $run_time = sprintf('%0.4f', microtime_float() - $time_start);?>
Processed in <?php echo $run_time?> seconds. <?php echo memory_usage();?> memory usage.<br /><u style="float: right; margin-top: -15px;"><a href="#header"></a></u>
